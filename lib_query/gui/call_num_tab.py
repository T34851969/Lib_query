...
def create(app, parent):
    ...
    ttk.Radiobutton(batch_format_frame, text=".xlsx", variable=app.cn_batch_format_var,
                    value="excel").pack(side=tk.LEFT, padx=4)
    ttk.Radiobutton(batch_format_frame, text=".csv", variable=app.cn_batch_format_var,
                    value="csv").pack(side=tk.LEFT, padx=4)
